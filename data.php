...
try {
	...
	$KV_ENDPOINT = 'https://lab-vault.vault.azure.net/secrets/' . $read_db_key  . '?api-version=2016-10-01';
	...
	$KV_ENDPOINT = 'https://lab-vault.vault.azure.net/secrets/' . $write_db_key  . '?api-version=2016-10-01';
	$r = $client->request('GET', $KV_ENDPOINT, [
		'headers' => [
			'Authorization' => 'Bearer ' . $access_token
		]
